  ...
  return (
    <div className={`flex items-center space-x-3 ${className}`}>
      ...
      <div className="flex flex-col justify-center mt-1">
        <span className="text-white text-[26px] font-black leading-none tracking-tight" style={{ fontFamily: 'Arial, system-ui, sans-serif' }}>
          GALAXY
        </span>
        <span className="text-[#e2b13c] text-[10px] font-bold tracking-[0.35em] uppercase mt-1">
          INTERIOR
        </span>
      </div>
    </div>
